...
import { resolveSymbol } from '../utils/symbolSearch'
import { getTransport } from '../transport'
import { STORAGE_KEYS } from '../constants/storageKeys'
import type { AppPage, RecentAnalysis } from '../types'
import type { HistoryEntry, HistoryMeta } from '../transport'
...
export function useAppState() {
  ...
  return {
    ...
    savedEntry,
    saving,
    // Analysis state from useAnalyze
