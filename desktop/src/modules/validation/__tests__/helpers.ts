...
export function makeIndicators(overrides: Partial<IndicatorResult> = {}): IndicatorResult {
  return {
    ...
    vwap: { available: true, value: 92, unavailable: null, anchorTime: 0 },
...
export function makeVolumeAnalysis(overrides: Partial<VolumeAnalysisResult> = {}): VolumeAnalysisResult {
  return {
    ...
    vwapAnalysis: { available: true, unavailable: null, value: 92, side: 'above', distancePercent: 8.7, respectingVWAP: false },
    overallStrength: 5,
    evidence: [],
    ...overrides,
  }
...
export function makeValidResult(overrides: Partial<MarketAnalysisResult> = {}): MarketAnalysisResult {
  ...
  return {
    ...
    volumeContext: {
      ...
      vwap: { available: true, unavailable: null, value: 92, side: 'above', distancePercent: 8.7, respectingVWAP: false },
