...
import { LayoutGrid, BarChart2, Activity, Clock, Settings, type LucideIcon } from 'lucide-react'
...
export const WebBottomNav = memo(function WebBottomNav({ activePage, onNavigate }: WebBottomNavProps) {
  return (
    <nav
