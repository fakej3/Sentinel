...
import { LayoutGrid, BarChart2, Activity, Star, Clock, Film, Radar, Settings, Stethoscope, type LucideIcon } from 'lucide-react'
...
const NAV_ITEMS: NavItem[] = [
  ...
  { page: 'diagnostics', label: 'Diagnostics', icon: Stethoscope },
]
...
export const WebSidebar = memo(function WebSidebar({ collapsed, activePage, onNavigate }: WebSidebarProps) {
  return (
    <aside
      className={clsx(
